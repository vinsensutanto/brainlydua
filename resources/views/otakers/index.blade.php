...
<head>
  ...
  <title>{{ config('app.name', 'Otak-otak') }} | User</title>
                ...
                @if(count($users)>0)
                  @foreach($users as $user)
                    ...
                    |
                      ...
                      <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modaluser{{$user->id}}">
                      Delete
                      </button>
                      <!-- Modal -->
                      <div class="modal fade" id="modaluser{{$user->id}}" tabindex="-1" aria-labelledby="modaluserLabel" aria-hidden="true">
                      ...
                      <h5 class="modal-title" id="modaluserLabel">Konfirmasi Penghapusan user</h5>
                    ...
                    @endforeach
                    @else
                      <td colspan="4" class="alert alert-danger">Tidak ada data user yang dapat ditampilkan</td>
                    @endif
                  </tfoot>
                </table>
              </div>
